...
public final class MoonAgeCalculator {
    
    public init() { }
    
}

// MARK: - MoonAgeCalculatorProtocol

extension MoonAgeCalculator: MoonAgeCalculatorProtocol {
